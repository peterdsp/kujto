...
|---|---|---|
| MVC | [mvc.md](mvc.md) | Pattern klasik Apple, ekrane te vegjel UIKit |
| MVP | [mvp.md](mvp.md) | UIKit me View pasive dhe Presenter te testueshem |
...
| ReactorKit | [reactorkit.md](reactorkit.md) | RxSwift me Action, Mutation, State |
| RIBs | [ribs.md](ribs.md) | App shume te medha me peme business logic dhe router-a |
...
4. **Kodbaze ekzistuese UIKit me MVC te vogel dhe te paster**: mbaje MVC, mos e rishkruaj kot.
5. **Kodbaze UIKit ku do testim me View pasive**: MVP ose MVVM-C.
6. **Kodbaze ekzistuese UIKit me coordinator**: MVVM-C, mos ndrysho per hir te ndryshimit.
7. **Ekip i madh, ndarje shume strikte rolesh, UIKit**: VIPER.
8. **Pjese e madhe biznes-logjike me rregulla komplekse**: Clean Architecture me shtresa (UI + Domain + Data).
9. **Nje screen me hapa te qarte input -> output**: Clean Swift / VIP.
10. **Kodbaze RxSwift me state unidirectional**: ReactorKit.
11. **App shume e madhe me flows te pavarura dhe peme ownership-i**: RIBs.
...
|---|---|---|
| MVC | [mvc.md](mvc.md) | Classic Apple pattern, small UIKit screens |
| MVP | [mvp.md](mvp.md) | UIKit with passive View and testable Presenter |
...
| ReactorKit | [reactorkit.md](reactorkit.md) | RxSwift with Action, Mutation, State |
| RIBs | [ribs.md](ribs.md) | Very large apps with business-logic trees and routers |
...
4. **Existing UIKit codebase with small clean MVC**: keep MVC, do not rewrite it for nothing.
5. **UIKit codebase where you want passive View testing**: MVP or MVVM-C.
6. **Existing UIKit codebase with coordinator**: MVVM-C, do not change for the sake of changing.
7. **Large team, very strict role separation, UIKit**: VIPER.
8. **Large slice of business logic with complex rules**: Clean Architecture with layers (UI + Domain + Data).
9. **One screen with clear input -> output steps**: Clean Swift / VIP.
10. **RxSwift codebase with unidirectional state**: ReactorKit.
11. **Very large app with independent flows and ownership trees**: RIBs.
